...
<head>
    ...
    <title>User Profile | NexGen</title>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4 border-end">
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        ?>
                                            <img src="resources/Untitled.......png" class="rounded mt-5" style="width: 150px;" id="img" />
                                        <?php
                                        } else {
                                        ?>
                                ...
                                <div class="col-md-8 border-end" style="background-color: gainsboro;">
                                    <div class="p-3 py-5">
