...
<body>
    ...
    <div class="container-fluid">
        <div class="row gy-3" style="background-color: gray;">
            <?php
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="h2 text- fw-bold">Add New Product</h2>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-2 pm pm2"><img src="images/icons/icon-pay-03.png" alt=""/></div>
                                                        <div class="col-2 pm pm3"><img src="images/icons/icon-pay-02.png" alt=""/></div>
                                                        <div class="col-2 pm pm4"><img src="images/icons/icon-pay-04.png" alt=""/></div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resources/upload product.jpg" class="img-fluid" style="width: 250px;" id="i0"/>
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resources/upload product.jpg" class="img-fluid" style="width: 250px;" id="i1"/>
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resources/upload product.jpg" class="img-fluid" style="width: 250px;" id="i2"/>
                                                </div>
                                            </div>
                                        </div>
