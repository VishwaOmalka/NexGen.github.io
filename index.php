...
<body class="main-body">
        ...
        <a href="#" class="logo col-12 fixed-top d-none d-lg-block">
          <img src="resources/logo2.png" alt="NexGen Electronics" width="270" height="90" />
        </a>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12">
                        <p class="text-center title1">Hi,<br/> Welcome To NexGenElectronics</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 " id="signInBox">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn1" onclick="signIn();">Sign In</button>
                            </div>
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn2 " onclick="changeView();">New Member? Create Account</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 d-none" id="signUpBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn3" onclick="changeView();">Account Allready have? Sign In</button>
                            </div>
            ...
            <div class="col-12 fixed-bottom d-none d-lg-block">
                <p class="text-center">&copy; 2024 NexGenElectronics | All Rights Reserved</p>
            </div>
            <!-- footer -->
