                        ...
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                    ...
                                    ?>
                                        <img src="resources/Untitled.......png" width="90px" height="90px" class="rounded-circle" />
                                    <?php
                                    }
                                    ?>
                                </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="col-12 col-lg-9 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                <button class="btn1" onclick="window.location='addProduct.php'">Add Product</button>
                            </div>
                        </div>
